---
title: "Changelog"
description: "All notable changes to Commerce Chain"
section: "Project"
---

{/* Synced from bd-forge-main packages/oss/CHANGELOG.md (mirrored to github.com/commerce-chain/scm-dcm) — update both when releasing */}

{/* Maintained in bd-forge-main. Mirrored to github.com/commerce-chain/scm-dcm on release. */}
