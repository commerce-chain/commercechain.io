...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!post) {
    return {
      title: "Post Not Found — Commerce Chain Blog",
      ...
      <article className="content-grid" style={{ maxWidth: "820px", margin: "0 auto" }}>
        ...
        >
          ...
          <div style={{ marginTop: "var(--space-6)", paddingTop: "var(--space-6)", borderTop: "1px solid var(--color-border)" }}>
            <p style={{ fontWeight: 600, marginBottom: "var(--space-2)" }}>Built with Commerce Chain</p>
            <p>
              Building governed supply and demand chain operations?{" "}
              <Link href="/docs/getting-started/quick-start" className="text-link">
                View the docs →
              </Link>{" "}
              or{" "}
              <a href="https://github.com/commercechain/commerce-chain" target="_blank" rel="noopener noreferrer" className="text-link">
                star on GitHub →
              </a>
            </p>
          </div>
